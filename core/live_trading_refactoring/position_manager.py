...
class PositionManager:
    ...
    def on_trade_plan(self, plan: TradePlan):
        # guard: already active
        if self._has_active_position(plan.symbol):
            print("⚠️ Position already active – skipping")
            return

        print("🚀 EXECUTING ENTRY (DRY-RUN)")
        ...
        self.repo.record_entry_from_plan(plan, result)
